...
data "oci_core_vnic" "control_plane_primary_vnic" {
  ...
  depends_on = [data.oci_core_vnic_attachments.control_plane_primary_vnic_attachments, oci_core_instance.control_plane_rendezvous, oci_core_instance.control_plane_node]
}
